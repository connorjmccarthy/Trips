...
days = [
  ...
  day('2026-12-11', 'A day in Bergen, then the ship', 'Bergen',
    ...
    item('b8', '20:30', 'boat', 'Hurtigruten sails for Kirkenes', location='Bergen', status='booked',
         notes='CHECK YOUR PAPERWORK ON THIS ONE. You told Connor 09:30, but Hurtigruten has sailed from Bergen at 20:30 for years and the 14:45 you gave for the return is exactly right, which says the booking is the classic 12-day round voyage. If it really is 09:30 the whole of this day changes, so read the confirmation and tell him. If it is 20:30, today is a free day in Bergen you did not know you had.')]),
  # ---------------------------------------------------------------- cruise
  ...
  day('2026-12-22', 'Back in Bergen', 'Bergen',
    ...
    item('c2', '16:00', 'stay', 'One night in Bergen', location='See Stays',
         notes='Same hotel as the 10th if they have it; you will know the way.')]),
  day('2026-12-23', 'Bergen to London', 'London',
      'Home to her place, with Christmas Eve clear.', [
    item('c3', '12:00', 'flight', 'Norwegian, Bergen to Gatwick', location='Bergen Flesland to London Gatwick',
         ...
         notes='Book this at the same time as the outbound. Whatever you do, do not take the last flight of the day on the 23rd of December.')]),
  ...
  # ---------------------------------------------------------------- Dublin
  day('2026-12-27', 'Fly to Dublin', 'Dublin',
      'THE IRELAND WINDOW. Two nights between Christmas and the football, which is the only gap on the whole trip that fits it. Take hand luggage only.', [
    item('d1', '10:00', 'flight', 'London to Dublin', location='Heathrow, Gatwick, Stansted or Luton to Dublin',
         cost=120, currency='AUD', status='idea',
         notes='About 1h25 and they go all day from every London airport. Aer Lingus and Ryanair both. Book when the dates are settled. Ireland is not in the UK, so you clear passport control, but Australians need nothing beyond the passport.'),
    item('d2', '15:00', 'stay', 'Check in, Dublin', location='See Stays',
         notes='Stay near the centre, around Temple Bar or Grafton Street, so everything is walkable and you are not learning a bus network for two nights.')]),
  day('2026-12-28', 'Guinness, and then better Guinness', 'Dublin',
      'The one day you came for.', [
    item('d3', '10:30', 'activity', 'Guinness Storehouse', location='St James’s Gate, Dublin 8',
         endTime='13:00', cost=30, currency='EUR',
         notes='Seven floors about how it is made, ending at the Gravity Bar on the roof with a 360-degree view over Dublin and a pint included in the ticket. BOOK ONLINE AND IN ADVANCE, it is the most visited thing in Ireland and it sells out. About €30. Two hours is enough.'),
    item('d4', '14:00', 'food', 'The real pint: the Long Hall, Kehoe’s or the Palace Bar',
         location='South Great George’s St, South Anne St, Fleet St', cost=8, currency='EUR',
         notes='This is the actual point. The Storehouse is the tour; these are the pubs. Victorian interiors, no televisions, and a barman who pours it in two goes and lets it settle. Ask for a pint of Guinness and then leave it alone for two minutes. Also worth it: EPIC, the Irish emigration museum at the docks, which is genuinely good and half an hour away on foot.'),
    item('d5', '17:00', 'food', 'Dinner, and a session if you find one', location='Around Temple Bar, but not in it',
         cost=35, currency='EUR',
         notes='Temple Bar itself is a tourist trap and charges double. Walk two streets out. Irish stew, or seafood chowder with brown bread. Live traditional music happens most nights around Christmas; ask the barman where, not the internet.')]),
  day('2026-12-29', 'Dublin to London', 'London',
      'Back today, not tomorrow. The football is tomorrow and you are not leaving it to a morning flight.', [
    item('d6', '17:00', 'flight', 'Dublin to London', cost=120, currency='AUD', status='idea',
         notes='An afternoon or early evening flight. Keeps the whole of tomorrow clear.')]),
  # ---------------------------------------------------------------- football
  ...
  day('2027-01-02', 'Fly to Spain, and get to Sarria', 'Sarria',
    ...
    item('f1', '07:40', 'flight', 'Ryanair, Stansted to Santiago de Compostela',
         location='London Stansted to Santiago de Compostela', endTime='10:50',
         cost=150, currency='AUD', status='idea',
         notes='Ryanair is the only nonstop and IT ONLY FLIES MONDAY, WEDNESDAY AND SATURDAY. That is why today is a Saturday and why you come home on Saturday the 9th. About 2h10. Stansted is an early start from London, so consider a hotel at the airport the night before. Hand luggage only if you can: you are carrying this for six days.'),
    item('f2', '12:30', 'train', 'Santiago to Sarria', location='Santiago de Compostela to Sarria',
         endTime='15:00', cost=25, currency='EUR',
    ...
    item('f3', '16:00', 'stay', 'First night in Sarria', location='See Stays',
  ...
  day('2027-01-09', 'Santiago to London', 'London',
    ...
    item('h2', '18:00', 'stay', 'Last night in London', location='Her place, or a hotel near Heathrow',
         notes='A HEATHROW HOTEL IS WORTH IT TONIGHT if she does not live west. Tomorrow is a 13:40 flight, you will be tired from a week of walking, and crossing London with a case on a Sunday morning with engineering works is a poor way to end five weeks.')]),
...
# =============================================================================
budget = [
  # Flights and ticketed activities are priced on the itinerary, where the cost
  # sits next to the thing. Beds are priced on Stays, where you will update them
  # when you book. This page is only for what has no home of its own, so nothing
  # is counted twice.
  dict(id='bg9', category='Food', label='Food and drink in the UK and Ireland, about 21 days', amount=1900, currency='AUD', status='estimate',
       notes='About A$90 a day eating reasonably and having a few pints. Less on the days your daughter cooks. The named meals in Dublin and Santiago are already on the itinerary and are not in this number.'),
  dict(id='bg10', category='Food', label='Food and drink in Spain, 8 days', amount=500, currency='AUD', status='estimate',
       notes='About A$65 a day, and Galicia is good value. The menu del dia is three courses, bread and a glass of wine for 12 to 15 euro at lunchtime, which is how to eat on a walking day.'),
  dict(id='bg11', category='Food', label='Eating ashore in Norway, 2 days', amount=250, currency='AUD', status='estimate',
       notes='Meals on the ship are included, so this is only the two days in Bergen, where a pint is about A$16 and a modest lunch A$35.'),
  dict(id='bg14', category='Transport', label='Tubes, buses, airport trains, an Oyster card', amount=350, currency='AUD', status='estimate',
       notes='The Gatwick and Stansted Express runs, getting about London for five weeks, and the Bybanen in Bergen. The Santiago to Sarria train is on the itinerary.'),
  dict(id='bg15', category='Other', label='Travel insurance, 37 days, age 63, with cruise cover', amount=400, currency='AUD', status='estimate',
       notes='Shop around, but do not buy the cheapest without reading what it says about cruises. Cruise cover is nearly always a separate tick box.'),
  ...
  dict(id='bg18', category='Other', label='Camino luggage transfer, 6 stages', amount=80, currency='AUD', status='estimate',
       notes='About 8 euro a stage for a van to take the bag on to the next guesthouse. Optional, and see Decisions, but it is the difference between walking with 3 kg and 8 kg.'),
  dict(id='bg17', category='Other', label='Contingency', amount=600, currency='AUD', status='estimate',
       notes='Five weeks. Something always comes up: a taxi you did not plan, a jumper you did not pack, a round you insist on buying.'),
]

questions = [
  dict(id='q1', question='Does the Hurtigruten booking really say 09:30?',
       why='You told Connor the ship leaves at 09:30 on the 11th. Hurtigruten has sailed from Bergen at 20:30 for years, and the 14:45 you gave for the return is exactly their Bergen arrival time, which says this is the classic 12-day round voyage. If it is 20:30, you have a free day in Bergen. If it really is 09:30, the whole of the 10th and 11th changes.',
       options=['20:30, as Hurtigruten normally sails', 'It really does say 09:30', 'Not sure, need to find the confirmation'],
       recommendation='Read the confirmation email and tell Connor. Everything about the 10th and 11th of December hangs on it.', answer='', resolved=False),
  dict(id='q2', question='Which nights are you at your daughter’s and which need a hotel?',
       why='It is the biggest number in the budget by a distance. Each night at hers saves about A$220, and ten hotel nights against five is a A$1,100 difference. It also needs asking rather than assuming: five weeks is a long time to have a guest, even your own father.',
       options=['Mostly at hers, a hotel for a few nights', 'Christmas and New Year at hers, hotel otherwise', 'Mostly hotel, at hers for Christmas'],
       recommendation='Ask her outright and take the answer at face value. Then book the hotel nights in November, because London in December is not a city to leave to the last minute.', answer='', resolved=False),
  dict(id='q3', question='Luggage transfer on the Camino, yes or no?',
       why='For about €8 a stage a van takes your bag to the next guesthouse and you walk with a daypack. Purists carry everything. At 63, over six days, in Galician rain, carrying 8 kg is a genuinely different walk to carrying 3 kg.',
       options=['Use it every day, walk light', 'Carry everything, that is the point', 'Book it and decide each morning'],
       recommendation='Use it. Nobody at the Pilgrim’s Office asks, the Compostela is the same, and you will enjoy the six days more. About €50 for the week.', answer='', resolved=False),
  dict(id='q4', question='Do you want a scenic train day, or are the trains just transport?',
       why='You said you like the idea of a proper train journey. There are two already inside this trip: Santiago to Sarria through Galicia, and the option of coming back from Santiago to Madrid on the high-speed line instead of flying. Neither is a hardship. The famous scenic ones in Britain, like Glasgow to Mallaig, are dark by four in January.',
       options=['The trains already in the plan are enough', 'Add a day for one scenic line', 'Come home from Santiago via Madrid by train'],
       recommendation='Leave it. There is a lot in these five weeks already and the Camino is the part you will remember.', answer='', resolved=False),
]

stays = [
  dict(id='sy1', name='Your daughter’s place', town='London', status='booked', nights=0,
       type='Family', notes='Which nights is Decisions question 2. Once you know, put the number in here and the budget sorts itself out.'),
  dict(id='sy2', name='London hotel nights', town='London', status='planned', pricePerNightAud=220, nights=10,
       type='Hotel, to be chosen', notes='Placeholder for whatever is not at hers. Book in November.'),
  dict(id='sy3', name='Bergen, night of 10 Dec', town='Bergen', status='planned', pricePerNightAud=250, nights=1,
       checkIn='2026-12-10', checkOut='2026-12-11', distance='Walkable to Bryggen and the Hurtigruten terminal',
       type='Hotel', notes='The night before the ship. Somewhere central so the whole of the 11th is on foot.'),
  dict(id='sy4', name='Bergen, night of 22 Dec', town='Bergen', status='planned', pricePerNightAud=250, nights=1,
       checkIn='2026-12-22', checkOut='2026-12-23', type='Hotel',
       notes='Off the ship at 14:45 and fly to London tomorrow. Same hotel as the 10th if they have it.'),
  dict(id='sy5', name='Dublin, 27 to 29 Dec', town='Dublin', status='planned', pricePerNightAud=200, nights=2,
       checkIn='2026-12-27', checkOut='2026-12-29', type='Hotel',
       notes='Near Grafton Street or the south quays. Walkable to everything, including the Storehouse at a push.'),
  dict(id='sy6', name='Sarria, night of 2 Jan', town='Sarria', status='planned', pricePerNightAud=110, nights=1,
       checkIn='2027-01-02', checkOut='2027-01-03', type='Guesthouse'),
  dict(id='sy7', name='Portomarín, night of 3 Jan', town='Portomarín', status='planned', pricePerNightAud=110, nights=1,
       checkIn='2027-01-03', checkOut='2027-01-04', type='Guesthouse'),
  dict(id='sy8', name='Palas de Rei, night of 4 Jan', town='Palas de Rei', status='planned', pricePerNightAud=110, nights=1,
       checkIn='2027-01-04', checkOut='2027-01-05', type='Guesthouse'),
  dict(id='sy9', name='Melide, night of 5 Jan', town='Melide', status='planned', pricePerNightAud=110, nights=1,
       checkIn='2027-01-05', checkOut='2027-01-06', type='Guesthouse'),
  dict(id='sy10', name='Arzúa, night of 6 Jan', town='Arzúa', status='planned', pricePerNightAud=110, nights=1,
       checkIn='2027-01-06', checkOut='2027-01-07', type='Guesthouse'),
  dict(id='sy11', name='O Pedrouzo, night of 7 Jan', town='O Pedrouzo', status='planned', pricePerNightAud=110, nights=1,
       checkIn='2027-01-07', checkOut='2027-01-08', type='Guesthouse'),
  dict(id='sy12', name='Santiago de Compostela, night of 8 Jan', town='Santiago de Compostela', status='idea',
       pricePerNightAud=140, nights=1, checkIn='2027-01-08', checkOut='2027-01-09', type='Hotel',
       notes='The night you arrive. Somewhere in the old town, within sight of the cathedral if you can.'),
  dict(id='sy13', name='Stansted airport hotel, night of 1 Jan', town='London', status='idea',
       pricePerNightAud=180, nights=1, checkIn='2027-01-01', checkOut='2027-01-02', type='Airport hotel',
       notes='A 07:40 flight out of Stansted on New Year’s Day morning is not a thing to attempt from central London.'),
]
...
trip = dict(
  meta=dict(
    ...
    about='Thirty-six nights: London with your daughter, eleven on the Hurtigruten chasing the northern lights, Christmas in London, Dublin for the Guinness, Arsenal on the 30th, and the last 115 km of the Camino into Santiago. Open Go to see only what is happening now. Everything still to decide is on Decisions, one question at a time.',
  ),
  days=days,
